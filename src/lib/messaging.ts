...
const ERRORS: [string, string][] = [
  ...
  ['one_way', 'هذه المحادثة للإعلانات فقط ولا تقبل الردود'],
  ['children_cannot_reply', 'الردود من المخدومين غير مفعّلة'],
  ['children_cannot_start', 'بدء المحادثات من المخدومين غير مفعّل'],
  ['not_member', 'أنت لست عضواً في هذه المحادثة'],
  ['automation_not_found', 'الرسالة التلقائية غير موجودة'],
  ['not_time_based', 'هذه الرسالة التلقائية تعمل بالأحداث ولا يمكن تشغيلها يدوياً'],
